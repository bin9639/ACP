      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="flex items-center justify-between w-full max-w-5xl">
          <div className="flex items-center">
            ...
            <a href="/classes" className="ml-4 text-gray-600 hover:text-gray-900">
              Các khóa học
            </a>
          ...
          <div className="flex items-center">
            <button className="text-gray-600 hover:text-gray-900">Light</button>
            <button className="ml-4 text-gray-600 hover:text-gray-900">Dark</button>
          </div>
        </div>
      </main>
    );
